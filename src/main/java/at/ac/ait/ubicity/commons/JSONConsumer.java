        ...
        while( true )   {
            try {
                ...
                try {
                    ...
                    IndexRequestBuilder indexRequestBuilder = elasticsearchClient.prepareIndex( AbstractCore.index, AbstractCore.type);
                ...
                if( json instanceof ConsumerPoison ) AbstractCore.getInstance().callBack( new Obituary( plugin ) );
